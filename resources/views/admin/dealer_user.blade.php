      ...
      <div class="container-fluid">
         ...
         <div class="row page-titles mb-0 border-bottom mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
               <a class="btn btn-success product_add_button" href="{{route('admin_dealer_user_form_show')}}">Add User</a> 
            </div>
         </div>
         ...
         @include('admin.dealer_user_show')
      </div>
  </div>

   <!--For Model -->
   <!-- Delete user -->
   @include('admin.model.delete_dealer_user')
   <!-- End of delete user -->
