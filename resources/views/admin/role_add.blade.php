   ...
   <div class="container-fluid">
      ...
      <div class="col-lg-12" id="role_add_model" >
         <div class="card">
            ...
            <form action="{{ route('admin_post_role_show') }}" method="post" enctype="multipart/form-data" onSubmit="return form_check(this)">
            @csrf
               <div class="card-body">
                  <div class="basic-form">
                     ...
                     <div class="row"> 
                                    ...
                                    <div class="row">
                                       ...
                                       @foreach($permissions as $permission)
                                          ...
                                          @endphp
                                           ...
                                           <label>
                                                <input class="form-check-input permission_check" type="checkbox" name="permission[]" value="{{$permission->id}}"  >&nbsp;&nbsp;{{ $permission->displayName }}
                                           </label>
                                           <br/>
                                          @php 
                                             if($count == 0){
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <button type="submit" class="btn btn-primary">Submit</button>&nbsp; <a href="{{route('admin_role_show')}}" class="btn btn-danger">Back</a>
