               ...
               <div class="card-header">
                   ...
                   <div class="row">
                       ...
                       <div class="col-lg-4 mb-3">
                           @can('user-delete')
                             <form id="bulk_delete_form" method="GET" action="{{ route('admin_user_show') }}">
                       ...
                       <div class="col-lg-4 mb-3">
                           @can('user-edit')
                              <form id="change_status_form" method="GET" action="{{ route('admin_user_show') }}">
                       ...
                       <div class="col-lg-4 mb-3">
                           <form method="GET" action="{{ route('admin_user_show') }}">
                                ...
                                <select class="form-control" id="single-select" name="search_by_role" onchange="this.form.submit()">
                                   ...
                                   @if($roles)
                                      @foreach($roles as $role)
                                         <?php $dash=''; ?>
                                         <option value="{{$role->id}}" @if(app('request')->input('search_by_role') == $role->id) selected @endif>{{$role->name}}</option>
                        ...
                        <tbody>
                           ...
                           @endphp
                            @foreach($users as $user)
                              ...
                              <tr>
                                 ...
                                 <td style="text-align:center;"> 
                                    ...
                                    @can('user-edit')
                                       ...
                                       <a href="{{route('admin_user_edit',[$user->id])}}"  class="btn btn-primary shadow btn-xs sharp me-1 editModal"><i class="fas fa-pencil-alt"></i></a>
                              ...
                              @include('admin.model.view_admin_user')
