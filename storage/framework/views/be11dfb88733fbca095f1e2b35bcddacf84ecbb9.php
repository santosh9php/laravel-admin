<div class="modal fade" id="delete_faq">
   <div class="modal-dialog modal-dialog-centered" role="document">
      <form method="POST" action="<?php echo e(route('admin_delete_faq_show')); ?>">
         <?php echo csrf_field(); ?>
...
</div> <?php /**PATH C:\xampp\htdocs\bathroom_product\resources\views/admin/model/delete_faq.blade.php ENDPATH**/ ?>