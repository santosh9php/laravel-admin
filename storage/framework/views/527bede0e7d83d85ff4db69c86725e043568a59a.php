            ...
            <div class="card">
               <div class="card-header"> 
                  ...
                  -->
                   <div class="row">
                           <div class="col-lg-4">
                              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('faq-category-edit')): ?>
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              ...
                              <tr>
                                 ...
                                 <td style="text-align:center;"> 
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('faq-category-delete')): ?>
...
<?php /**PATH C:\xampp\htdocs\bathroom_product\resources\views/admin/faq_category_show.blade.php ENDPATH**/ ?>