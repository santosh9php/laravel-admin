      ...
      <td>
					...
					<table width="100%" border="0" style="background: #fff1f2;color: #555; font-family: 'Poppins', sans-serif; max-width: 700px; margin: 0 auto;">
					  <tbody>
						...
						<tr>
						  ...
						  <td colspan="2">
								  <div style="background: #fff;font-family: poppins;  line-height: 35px; color: #555; font-size: 14px;font-family:arial;border: 2px solid #fde4e4;">
									  ...
									  <img src="<?php echo e(asset('admin_assets/images/mail/change_password.png')); ?>" />
						...
						<p style="font-family: poppins; ">your password has been changed successfully.<br>Your new password is :- <span style="color: #FF2D37; font-weight: 600;"><?php echo e($user['password']); ?></span> </p> 
...
</html><?php /**PATH C:\xampp\htdocs\bathroom_product\resources\views/admin/email/change_password.blade.php ENDPATH**/ ?>