                                        ...
                                        <select class="default-select  form-control wide" id="single-select" name="search_category" onchange="this.form.submit()">
                                           ...
                                           <?php if($categories): ?>
                                              <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                 <?php $dash=''; ?>
                                                 <option value="<?php echo e($category->id); ?>" <?php if(app('request')->input('search_category') == $category->id): ?> selected <?php endif; ?>><?php echo e($category->name); ?></option>
                                                 <?php if(count($category->subCategory)): ?>
                                                    <?php echo $__env->make('admin.subCategory.subCategory_search',['subcategories' => $category->subCategory], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                 <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\bathroom_product\resources\views/admin/category_show.blade.php ENDPATH**/ ?>