                   ...
                   <div class="row">
                       ...
                       <div class="col-lg-4 mb-3">
                           <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-delete')): ?>
                             <form id="bulk_delete_form" method="GET" action="<?php echo e(route('admin_user_show')); ?>">
                       ...
                       <div class="col-lg-4 mb-3">
                           <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-edit')): ?>
                              <form id="change_status_form" method="GET" action="<?php echo e(route('admin_user_show')); ?>">
                       ...
                       <div class="col-lg-4 mb-3">
                           <form method="GET" action="<?php echo e(route('admin_user_show')); ?>">
                       ...
                       <div class="col-lg-4 mb-3">
                          <form method="GET" action="<?php echo e(route('admin_user_show')); ?>">
                             ...
                             <div>
                                <select class="form-control" id="single-select" name="search_by_role" onchange="this.form.submit()">
                                   <option value="">Select Role</option>
                                   <?php if($roles): ?>
                                      <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         <?php $dash=''; ?>
                                         <option value="<?php echo e($role->id); ?>" <?php if(app('request')->input('search_by_role') == $role->id): ?> selected <?php endif; ?>><?php echo e($role->name); ?></option>
                     ...
                     <table class="table table-responsive-md table-bordered table-striped ">
                        <thead>
                           <tr>
                              ...
                              <th class="create_date"><strong>Created Date</strong></th>
                              <th class="role"><strong>Verify</strong></th>
                              <th class="gender" style="width:130px;"><strong>Role</strong></th>
                        ...
                        <tbody>
                           ...
                           ?>
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              ...
                              <tr>
                                 ...
                                 <td style="text-align:center;"> 
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-edit')): ?>
                                       ...
                                       <a href="<?php echo e(route('admin_user_edit',[$user->id])); ?>"  class="btn btn-primary shadow btn-xs sharp me-1 editModal"><i class="fas fa-pencil-alt"></i></a>
                              ...
                              <?php echo $__env->make('admin.model.view_admin_user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\xampp\htdocs\bathroom_product\resources\views/admin/admin_user_show.blade.php ENDPATH**/ ?>