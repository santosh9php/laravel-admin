   ...
   <div class="container-fluid">
      ...
      <div class="row page-titles mb-0 border-bottom mx-0">
         ...
         <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('faq-category-add')): ?>
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bathroom_product\resources\views/admin/faq_category.blade.php ENDPATH**/ ?>