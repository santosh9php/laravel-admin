...
<body class="common-home res layout-3">
    ...
    <div class="container mt-5 pt-5 text-center">
        <br /><br /><br /> 
        <img src="<?php echo e(asset('frontend_assets/image/error.jpg')); ?>" alt="imgpayment" class="img-1 img-responsive"> <br />
        <h1 style="color:red; text-transform: capitalize;">Something went wrong</h1>
...
<?php /**PATH C:\xampp\htdocs\skmotor\resources\views/errors/422.blade.php ENDPATH**/ ?>