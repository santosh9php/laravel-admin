                     ...
                     <div class="product-item-container">
                        <div class="left-block">
                           <div class="product-image-container second_img">
                              <a href="<?php echo e(route('bodypart_product_search',[$category->slug])); ?>" target="_self" title="<?php echo e($category->name); ?> ">
                        ...
                        <div class="right-block">
                           <h4><a class="vehicle_name" href="<?php echo e(route('bodypart_product_search',[$category->slug])); ?>" title="<?php echo e($category->name); ?> " target="_self"><?php echo e($category->name); ?></a></h4>

                              <a class="view_product view_device" href="<?php echo e(route('bodypart_product_search',[$category->slug])); ?>" title="<?php echo e($category->name); ?> " target="_self">View Products  </a>                                   
...
<?php echo $__env->make('common.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skmotor\resources\views/bodypartProduct.blade.php ENDPATH**/ ?>