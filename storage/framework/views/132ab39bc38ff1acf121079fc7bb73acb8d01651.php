						  ...
						  <td colspan="2">
								  <div style="background: #fff;font-family: poppins;  line-height: 35px; color: #555; font-size: 14px;font-family:arial;border: 2px solid #fde4e4;">
									  ...
									  <div style="padding: 20px; text-align: center; ">
									    ...
									    <h3 style="font-size: 24px; color: #FF2D37;margin-bottom: 15px; ">Email OTP</h3>
						   								 
 								 
											<p style="font-family: poppins; ">
												
												 <br> OTP :   
												 <span style="color: #FF2D37; font-weight: 600;"> : <?php echo e($otp['token']); ?> </span></span> 
										  </p> 
										  <p style="font-family: poppins; ">
...
</html><?php /**PATH C:\xampp\htdocs\skmotor\resources\views/email/email_otp.blade.php ENDPATH**/ ?>