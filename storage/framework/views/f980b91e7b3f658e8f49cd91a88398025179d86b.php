						...
						<tr>
						  ...
						  <td colspan="2" style="text-align: center;">
								  <div style="background: #fff;font-family: poppins;  line-height: 35px; color: #555; font-size: 14px;font-family:arial;border: 2px solid #fde4e4;">
									  ...
									  <img src="<?php echo e(asset('admin_assets/images/mail/contact-us.png')); ?>" />
									  <div style="padding: 20px;">
									  
										    <h3 style="font-size: 24px; color: #FF2D37;margin-bottom: 15px; ">Customer Information </h3>

											<p style="font-family: poppins; ">Name :- <?php echo e($contactUsMsg->name); ?> </p> 
											<p style="font-family: poppins; ">email id : <?php echo e($contactUsMsg->email); ?>  </p> 
											<p style="font-family: poppins; ">Spare Part Name : <?php echo e($contactUsMsg->part_name); ?> </p> 
											<p style="font-family: poppins; ">Message : <?php echo e($contactUsMsg->message); ?> </p> 
...
</html><?php /**PATH C:\xampp\htdocs\skmotor\resources\views/email/contactUs.blade.php ENDPATH**/ ?>