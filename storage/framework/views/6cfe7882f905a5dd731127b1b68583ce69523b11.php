<div class="card mb-0  border-bottom" id="faq_category_add_model" >
   ...
   <div class="card-body" >
      <form action="<?php echo e(route('admin_post_faq_category_show')); ?>" method="post" enctype="multipart/form-data">
      <?php echo csrf_field(); ?>
         ...
         <div class="row">
          ...
          <div class="row">
            <div class="col-md-6">
               <button type="submit" class="btn btn-primary">Submit</button>&nbsp; <a href="#" class="btn btn-danger" id="faq_category_hide_form">Hide Form</a>
            </div>
            <div class="col-md-6">
...
<?php /**PATH C:\xampp\htdocs\bathroom_product\resources\views/admin/faq_category_add.blade.php ENDPATH**/ ?>