						...
						<tr>
						  ...
						  <td colspan="2">
								  <div style="background: #fff;font-family: poppins;  line-height: 35px; color: #555; font-size: 14px;font-family:arial;border: 2px solid #fde4e4;">
									  ...
									  <img src="<?php echo e(asset('admin_assets/images/mail/registration.png')); ?>" />
									  <div style="padding: 20px; text-align: center; ">
									  
									    <h3 style="font-size: 24px; color: #FF2D37;margin-bottom: 15px; ">Registration</h3>
						   								 
 								<p style="font-family: poppins; "><b>Hello<span style="color: #FF2D37;"> Admin</span> , </b></p> 
						<p style="font-family: poppins; ">
							
							One dealer has been registered successfully. His details are beign given below :- 
								<br> Name  
							  		<span style="color: #FF2D37; font-weight: 600;"> : <?php echo e($user['name']); ?> </span>
								<br> Email id  
							  		<span style="color: #FF2D37; font-weight: 600;"> : <?php echo e($user['email']); ?> </span>
							  <br>Country Code   
							   		<span style="color: #FF2D37; font-weight: 600;"> : <?php echo e($user['country_code']); ?> </span> 
							  <br>Mobile   
							   		<span style="color: #FF2D37; font-weight: 600;"> : <?php echo e($user['mobile']); ?> </span> 
						</p> 
									<br>
...
</html><?php /**PATH C:\xampp\htdocs\skmotor\resources\views/email/home_register_mail_admin.blade.php ENDPATH**/ ?>