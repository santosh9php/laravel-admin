                           ...
                           <td colspan="2">
                              <div style="background: #fff;font-family: verdana;  line-height: 35px; color: #878787; font-size: 14px;font-family: verdana;border: 2px solid #fde4e4;">
                                 ...
                                 <div style="padding: 20px; text-align: center; ">
                                    ...
                                    <p style="font-family: verdana; "><b>Hello<span style="color: #FF2D37;"> <?php echo e($order['b_fname']); ?>&nbsp;<?php echo e($order['b_lname']); ?></span> , </b></p>
                                    <p style="font-family: verdana; line-height: 25px; margin-top: 10px; ">Thank you for your order. We&rsquo;ll send a confirmation when your order ships. If you would like to view the status of your order or make any changes to it, please visit <a style="color: #FF2D37;" href="http://skautospares.com/" target="_blank">Your Orders</a> on</p>
                                 </div>
...
</html><?php /**PATH C:\xampp\htdocs\skmotor\resources\views/email/order_detail.blade.php ENDPATH**/ ?>