					  ...
					  <tbody>
						...
						<tr>
						  ...
						  <td colspan="2">
 								...
 								<p style="font-family: poppins; "><b>Hello<span style="color: #FF2D37;"> <?php echo e($user['name']); ?></span> , </b></p> 
						<p style="font-family: poppins; ">
							
							Your registration has done successfully. Your login details are beign given below :- <br> Email id  
							  <span style="color: #FF2D37; font-weight: 600;"> : <?php echo e($user['email']); ?> </span> <br>
										   Password : <span style="color: #FF2D37; font-weight: 600;"> <?php echo e($user['password']); ?> </span> 
										  </p> 
									<br>
...
</html><?php /**PATH C:\xampp\htdocs\skmotor\resources\views/admin/email/register.blade.php ENDPATH**/ ?>